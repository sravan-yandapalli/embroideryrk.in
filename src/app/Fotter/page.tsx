...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-white text-gray-600 relative z-20 overflow-hidden">
      {/* Colorful Top Border 
      ...
      */}
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-10 pt-16 pb-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 mb-16">
          ...
          >
            <h2 className="text-2xl font-black text-[#2B237C] tracking-tight mb-4 flex items-center gap-2">
              RK ENTERPRISES
            </h2>
            <p className="text-base leading-relaxed text-gray-600 mb-6 max-w-md">
          ...
          >
            <h3 className="text-[#2B237C] font-bold text-lg mb-6">Helpful Links</h3>
            <ul className="space-y-4">
              {quickLinks.map((link) => (
                <li key={link.label}>
                  <Link 
                    href={link.href} 
                    className="text-gray-600 hover:text-[#00AEEF] hover:translate-x-1 transition-all inline-block font-medium"
                  >
                    {link.label}
                  </Link>
                </li>
          ...
          >
            <h3 className="text-[#2B237C] font-bold text-lg mb-6">We're Here for You</h3>
            <ul className="space-y-6 text-sm">
              ...
              <li className="flex items-start gap-4">
                ...
                <span className="leading-relaxed text-gray-600 pt-0.5">
                  <strong className="text-gray-900 block mb-0.5 font-bold">Visit our store</strong>
              ...
              <li className="flex items-start gap-4">
                ...
                <div className="flex flex-col gap-1 pt-0.5">
                  <a href="tel:+917032839780" className="text-gray-700 hover:text-green-600 font-bold transition-colors">
                    +91 70328 39780
                  </a>
                  <a href="tel:+917032720972" className="text-gray-700 hover:text-green-600 font-bold transition-colors">
                    +91 70327 20972
                  </a>
                </div>
              </li>
              ...
              <li className="flex items-start gap-4">
                ...
                <a href="mailto:kavimanpowercreations@gmail.com" className="text-gray-600 font-medium hover:text-orange-500 transition-colors break-all pt-2">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-gray-500">
          <p>
            © {currentYear} <span className="font-semibold text-gray-700">Siri Ganesh Enterprises</span> & RK Enterprises. All rights reserved.
          </p>
          
          <div className="flex items-center gap-6 font-medium">
            <Link href="/privacy" className="hover:text-[#2B237C] transition-colors">Privacy Policy</Link>
            <Link href="/terms" className="hover:text-[#2B237C] transition-colors">Terms of Service</Link>
          </div>
        </div>
